    ...
    <div>
          ...
          <div className="flex flex-col justify-between gap-10 md:flex-row">
            ...
            <div className="flex flex-col gap-4 font-light">
              <FadeOnScroll delay={0.3}>
                ...
                >
                  <HiOutlineMail size={20} /> hello@example.com
                </a>
              </FadeOnScroll>
              <FadeOnScroll delay={0.4}>
                <a
                  ...
                  className="flex items-center gap-4"
                >
                  <HiOutlinePhone size={20} /> (001) 1234 5678
                </a>
              </FadeOnScroll>
      ...
      <div className="mx-8 flex flex-col justify-between gap-10 py-8 font-light text-white md:flex-row">
        ...
        <FadeOnScroll delay={0.6}>
          <a href="mailto:oliver.elias011@gmail.com">
            &copy; {currentYear} Oliver Elias - All Right Reserved
          </a>
        </FadeOnScroll>
      </div>
    </div>
